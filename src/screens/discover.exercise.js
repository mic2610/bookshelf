...
function DiscoverBooksScreen({user}) {
  ...
  const {data, error, isLoading, isError, isSuccess} = useQuery(['bookSearch', {query}], () => client(`books?query=${encodeURIComponent(query)}`, {token: user.token}).then(data => data.books));
