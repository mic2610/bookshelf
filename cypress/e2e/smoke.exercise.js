...
describe('smoke', () => {
  it('should allow a typical user flow', () => {
    ...
    cy.findByRole('listitem', {name: /The Lord of the Rings/i})
      .findByRole('button', {name: /add to list/i})
      .click();
    ...
    cy.findByRole('navigation')
      .findByRole('link', {name: /reading list/i})
      .click();
    //
    // 🐨 ensure the "main" only has one element "listitem"
    cy.findByRole('main').findByRole('listitem').should('have.length', 1);
    ...
    cy.findByRole('main').within(() => {
      cy.findByRole('textbox', {name: /notes/i}).type('This is a great book!');
